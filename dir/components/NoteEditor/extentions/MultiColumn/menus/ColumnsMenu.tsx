...
export const ColumnsMenu = ({ editor, appendTo }: MenuProps) => {
  ...
  return (
    ...
    >
      <ActionBar.Wrapper>
        <ActionBar.Button tooltip="Sidebar left" active={isColumnLeft} onClick={onColumnLeft}>
          <Icon name="PanelLeft" />
        </ActionBar.Button>
        <ActionBar.Button tooltip="Two columns" active={isColumnTwo} onClick={onColumnTwo}>
          <Icon name="Columns2" />
        </ActionBar.Button>
        <ActionBar.Button tooltip="Sidebar right" active={isColumnRight} onClick={onColumnRight}>
